...
namespace Sd.Update
{
    public class Updater
    {
        ...
        public Updater(string serverIP, int serverPort)
        {
            ...
            rapidPassiveEngine = RapidEngineFactory.CreatePassiveEngine();
            rapidPassiveEngine.WaitResponseTimeoutInSecs = 10;
            rapidPassiveEngine.AutoReconnect = true;
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                //List<string> list = rapidPassiveEngine.BasicOutter.GetAllOnlineUsers();

                    var logonResponse = rapidPassiveEngine.Initialize(userid, "", serverIP, serverPort, null);
